...
from effectiveworkout.usersprofiles.forms import UserProfileForm


class UsersProfilesNewGet(TestCase):
    def setUp(self):
        self.response = self.client.get(r('usersprofiles:new'))
...
class UsersProfilesNewPostValid(TestCase):
    def setUp(self):
    ...
    def test_post(self):
        ...
        self.response = self.client.post(r('usersprofiles:new'), self.data)


class UsersProfilesNewPostInvalid(TestCase):
    def setUp(self):
        self.response = self.client.post(r('usersprofiles:new'), {})
