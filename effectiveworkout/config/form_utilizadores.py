...
class AddUserForm(forms.Form):
    ...
    first_name = forms.CharField(max_length=30, label=_(u'Nome'),
                                 widget=forms.TextInput(attrs={'class': 'form-control input-sm medio required_form'}))
    last_name = forms.CharField(required=False, max_length=30, label=_(u'Sobrenome'),
...
class AddGroupForm(forms.Form):
    ...
    perm = forms.ModelMultipleChoiceField(
        queryset=Permission.objects.filter(content_type=500).order_by('content_type_id'),
