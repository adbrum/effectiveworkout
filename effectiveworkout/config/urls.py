...
from effectiveworkout.config.view_config import configuracao
from effectiveworkout.config.view_utilizadores import listUsers, fichaUser, resetPassword, desativarUsers, \
...
urlpatterns = [
    ...
    # Ativar Utilizador
    url(r'^users/reset/password/(?P<idUser>\d+)/$', resetPassword,
        name="resetPassword"),
