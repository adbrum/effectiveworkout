...
import effectiveworkout.exercises.models
import uuid
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('image', models.ImageField(help_text='Only PNG and JPEG formats are supported', upload_to=effectiveworkout.exercises.models.exercise_image_upload_dir, verbose_name='Image')),
