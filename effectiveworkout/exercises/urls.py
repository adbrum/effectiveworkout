...
from effectiveworkout.exercises.views.exercises import ExerciseListView, view
from effectiveworkout.exercises.views.muscle import MuscleListView, MuscleAdminListView, MuscleAddView, MuscleUpdateView, \
    MuscleDeleteView
