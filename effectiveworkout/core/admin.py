...
from effectiveworkout.reviewsphysicals.models import Avaliacao
...
class SaudeAnamneseAdmin(admin.ModelAdmin):
    ...
    def pk(self, obj):
        pk = UserProfile.objects.get(pk=obj.pk)
...
class PresencaAdmin(admin.ModelAdmin):
    app = 'effectiveworkout.assiduousness'
    ...
    # def pk(self, obj):
    #     pk = UserProfile.objects.get(pk=obj.numeroatleta)
    #     return pk.nome.title() + ' ' + pk.sobrenome.title()
    #
    # pk.short_description = 'Nome do atleta'
    class Meta:
        varbose_app = 'Assiduidade do UserProfile'
